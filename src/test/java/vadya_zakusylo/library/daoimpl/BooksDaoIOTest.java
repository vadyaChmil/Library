...
public class BooksDaoIOTest {
	static BooksDaoBrowser booksDaoBrowser;
	List<String> contentString;
	List<Book> downloadBookList;

	@BeforeClass
	public static void oneTimeSetUp() {
		booksDaoBrowser = new BooksDaoBrowser();
	}

	@AfterClass
	public static void oneTimeTearDown() {
		booksDaoBrowser = null;
	}
	...
	public void shouldParseStringToList_whenNoString() throws IOException {
		...
		String string = null;
		// then
		booksDaoBrowser.parseStringToList(string);
	}
	...
	public void shouldParseStringToList() {
		...
		// then
		contentString = booksDaoBrowser.parseStringToList(testString);
	...
	public void shouldCreateBookList_whenContentIncorrect() {
		...
		// then
		downloadBookList = booksDaoBrowser.createBookList(contentString);
